...
const NAV_LINKS: NavLinkItem[] = [
  { to: "/", label: "Početna" },
  { to: "/services", label: "Rešenja", hasDropdown: true },
  { to: "/products", label: "Asortiman", hasDropdown: true },
      ...
      <div className="hidden lg:block border-b border-[var(--border)]/60 bg-[#f2f6fb]">
        <div className="section flex h-8 items-center justify-between text-[0.7rem] text-neutral-500">
          <span className="font-medium tracking-[0.18em] uppercase">
            Pametan pristup. Besprekorno putovanje.
          </span>
          <div className="flex items-center gap-5 whitespace-nowrap">
            <a
              href="tel:+38121892762"
                ...
                <span className="relative flex items-center gap-1.5">
                  ...
                  <span
                    className={clsx(
                      ...
                      "group-hover:scale-x-100 mb-[-4px]",
